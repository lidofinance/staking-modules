...
interface IParametersRegistry {
    ...
    event DefaultElMaxWithdrawalRequestFeeSet(uint256 fee);
    ...
    event ElMaxWithdrawalRequestFeeSet(uint256 indexed curveId, uint256 fee);
    ...
    event ElMaxWithdrawalRequestFeeUnset(uint256 indexed curveId);
    ...
    /// @notice Get default value for EL max withdrawal request fee
    function defaultElMaxWithdrawalRequestFee() external returns (uint256);
    ...
    /// @notice set default value for EL max withdrawal request fee. Default value is used if a specific value is not set for the curveId
    /// @param fee value to be set as default for the EL max withdrawal request fee
    function setDefaultElMaxWithdrawalRequestFee(uint256 fee) external;
    ...
    /// @notice Set EL max withdrawal request fee for the curveId
    /// @param curveId Curve Id to associate EL max withdrawal request fee with
    /// @param fee EL max withdrawal request fee
    function setElMaxWithdrawalRequestFee(
        uint256 curveId,
        uint256 fee
    ) external;
    ...
    /// @notice Unset EL max withdrawal request fee for the curveId
    /// @param curveId Curve Id to unset EL max withdrawal request fee for
    function unsetElMaxWithdrawalRequestFee(uint256 curveId) external;
    ...
    /// @notice Get EL max withdrawal request fee by the curveId
    /// @dev `defaultElMaxWithdrawalRequestFee` is returned if the value is not set for the given curveId.
    /// @param curveId Curve Id to get EL max withdrawal request fee for
    function getElMaxWithdrawalRequestFee(
        uint256 curveId
