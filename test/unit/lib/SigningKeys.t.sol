...
contract Library {
    function saveKeysSigs(
        ...
        return SigningKeys.saveKeysSigs(nodeOperatorId, startIndex, keysCount, pubkeys, signatures);
    }
    ...
    function removeKeysSigs(
        ...
        return SigningKeys.removeKeysSigs(nodeOperatorId, startIndex, keysCount, totalKeysCount);
    }
    ...
    function loadKeysSigs(
        ...
        SigningKeys.loadKeysSigs(nodeOperatorId, startIndex, keysCount, keys, sigs, bufOffset);
    }
}
...
contract SigningKeysSaveTest is SigningKeysTestBase {
    function test_saveKeysSigs_HappyPath() public {
        ...
        (bytes memory pubkeys, bytes memory signatures) = keysSignatures(keysCount, startIndex);
        vm.expectEmit(address(signingKeys));
        emit IStakingModule.SigningKeyAdded(nodeOperatorId, pubkeys);
        uint256 newKeysCount = signingKeys.saveKeysSigs(nodeOperatorId, startIndex, keysCount, pubkeys, signatures);

        assertEq(newKeysCount, startIndex + keysCount);
        bytes memory loadedPubkeys = signingKeys.loadKeys(nodeOperatorId, startIndex, keysCount);
    ...
    function test_saveKeysSigs_revertWhen_zeroKeys() public {
        ...
        signingKeys.saveKeysSigs(nodeOperatorId, startIndex, keysCount, pubkeys, signatures);
    }
    ...
    function test_saveKeysSigs_revertWhen_tooManyKeys() public {
        ...
        (bytes memory pubkeys, bytes memory signatures) = (new bytes(0), new bytes(0));
    ...
    function test_saveKeysSigs_revertWhen_invalidSigsLen() public {
        ...
        signingKeys.saveKeysSigs(nodeOperatorId, startIndex, keysCount, pubkeys, new bytes(0));
    }
    ...
    function test_saveKeysSigs_revertWhen_invalidPubkeysLen() public {
        ...
        vm.expectRevert(SigningKeys.InvalidLength.selector);
        signingKeys.saveKeysSigs(nodeOperatorId, startIndex, keysCount, new bytes(0), signatures);
    }

    function test_saveKeysSigs_revertWhen_pubkeysAndSignaturesUnaligned() public {
        uint256 nodeOperatorId = 154;
        ...
        vm.expectRevert(SigningKeys.InvalidLength.selector);
        signingKeys.saveKeysSigs(nodeOperatorId, startIndex, 10, pubkeys, signatures);
    }
    ...
    function test_saveKeysSigs_revertWhen_EmptyKey() public {
        ...
        uint16 startIndex = 2;
        uint256 nodeOperatorId = 154;
        (bytes memory pubkeys, bytes memory signatures) = keysSignaturesWithZeroKey(keysCount, startIndex, 3);

        vm.expectRevert(SigningKeys.EmptyKey.selector);
        signingKeys.saveKeysSigs(nodeOperatorId, startIndex, keysCount, pubkeys, signatures);
    }

    function testFuzz_saveKeysSigs_HappyPath(uint64 nodeOperatorId, uint32 startIndex, uint32 keysCount) public {
    ...
    function testFuzz_saveKeysSigs_revertWhen_EmptyKey(
        ...
        (bytes memory pubkeys, bytes memory signatures) = keysSignaturesWithZeroKey(
            keysCount,
...
contract SigningKeysRemoveTest is SigningKeysTestBase {
    function test_removeKeysSigs_HappyPath() public {
        ...
        bytes memory lastAddedKey = slice(pubkeys, PUBKEY_LENGTH * 2, PUBKEY_LENGTH);
    ...
    function test_removeKeysSigs_noKeysAdded() public {
        ...
        vm.expectEmit(address(signingKeys));
        emit IStakingModule.SigningKeyRemoved(nodeOperatorId, new bytes(PUBKEY_LENGTH));
        signingKeys.removeKeysSigs(nodeOperatorId, startIndex, keysCount, startIndex + keysCount);
    }
    ...
    function test_removeKeysSigs_revertWhen_zeroKeys() public {
        ...
        vm.expectRevert(SigningKeys.InvalidKeysCount.selector);
        signingKeys.removeKeysSigs(nodeOperatorId, startIndex, 0, keysCount + startIndex);
    }

    function test_removeKeysSigs_revertWhen_keysPlusStartHigherThanTotal() public {
        uint256 keysCount = 1;
        uint16 startIndex = 2;
        uint256 nodeOperatorId = 154;

        vm.expectRevert(SigningKeys.InvalidKeysCount.selector);
        signingKeys.removeKeysSigs(nodeOperatorId, startIndex, keysCount, startIndex + keysCount - 1);
    }
    ...
    function test_removeKeysSigs_revertWhen_totalKeysTooHigh() public {
        ...
        vm.expectRevert(SigningKeys.InvalidKeysCount.selector);
        signingKeys.removeKeysSigs(nodeOperatorId, startIndex, keysCount, uint256(type(uint32).max) + 1);
    }
    ...
    function testFuzz_removeKeysSigs_offsetRight(
        ...
        (bytes memory pubkeys, bytes memory signatures) = keysSignatures(keysCount);
        uint256 totalKeysCount = signingKeys.saveKeysSigs(nodeOperatorId, startIndex, keysCount, pubkeys, signatures);
    ...
    function testFuzz_removeKeysSigs_NoKeysAdded(uint64 nodeOperatorId, uint32 startIndex, uint32 keysCount) public {
        ...
        uint256 newTotalKeysCount = signingKeys.removeKeysSigs(nodeOperatorId, startIndex, keysCount, totalKeysCount);
...
contract SigningKeysLoadTest is SigningKeysTestBase {
    ...
    function test_getKeyOffset() public pure {
        assertEq(
            ...
            SigningKeys.SIGNING_KEYS_POSITION.getKeyOffset({ nodeOperatorId: 1, keyIndex: 0 })
        );
        assertEq(
            uint256(0xd5b4059fcaec08c6b5ebefcaa178a5297fb8f60f7a096c6362bda9f5de3b2b2d),
            SigningKeys.SIGNING_KEYS_POSITION.getKeyOffset({ nodeOperatorId: 2, keyIndex: 0 })
        );
        assertEq(
            uint256(0x371c76b82d811a2203237a0d71bebb72f52de0f28f3c1f6efd70d326ffe58b66),
            SigningKeys.SIGNING_KEYS_POSITION.getKeyOffset({ nodeOperatorId: 2, keyIndex: 1 })
        );
    }
    ...
    function testFuzz_loadKeys(uint64 nodeOperatorId, uint32 startIndex, uint32 keysCount) public {
        keysCount = uint32(bound(keysCount, 1, 100));
        unchecked {
            vm.assume(startIndex + keysCount > startIndex);
        }
    ...
    function test_loadKeysSigs() public {
        ...
        (bytes memory loadedKeys, bytes memory loadedSigs) = signingKeys.loadKeysSigs(
            nodeOperatorId,
            startIndex,
            keysCount,
            0
    ...
    function testFuzz_loadKeysSigs(uint64 nodeOperatorId, uint32 startIndex, uint32 keysCount) public {
        keysCount = uint32(bound(keysCount, 1, 100));
        unchecked {
            vm.assume(startIndex + keysCount > startIndex);
        }

        (bytes memory pubkeys, bytes memory sigs) = keysSignatures(keysCount, startIndex);
        signingKeys.saveKeysSigs(nodeOperatorId, startIndex, keysCount, pubkeys, sigs);
