...
contract AdditionalBondRegistryConstructorTest is AdditionalBondRegistryBaseTest {
    function test_constructor_SetsImmutables() public view {
        ...
        assertEq(additionalBondRegistry.MAX_CURVE_MULTIPLIER(), MAX_EFFECTIVE_MULTIPLIER_BP - MAX_BP);
        assertEq(additionalBondRegistry.MAX_WEIGHT_MULTIPLIER(), MAX_EFFECTIVE_MULTIPLIER_BP - MAX_BP);
