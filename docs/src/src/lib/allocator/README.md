...
# Contents
- [CuratedDepositAllocator](CuratedDepositAllocator.sol/library.CuratedDepositAllocator.md)
- [AllocationState](DepositAllocatorGreedy.sol/struct.AllocationState.md)
