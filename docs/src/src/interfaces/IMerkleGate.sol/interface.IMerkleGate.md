# IMerkleGate
[Git Source](https://github.com/lidofinance/staking-modules/blob/daa40a3672f26250a2437c260b2926e18e6eb453/src/interfaces/IMerkleGate.sol)
...
|Name|Type|Description|
|----|----|-----------|
|`treeRoot`|`bytes32`|New root|
|`treeCid`|`string`|New CID|
