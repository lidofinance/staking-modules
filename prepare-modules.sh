...
SR_NEW_IMPL=0x490FE6742c369551eA46fa2a610ca79a47DDFe8B
...
if [ "$SR_VERSION" -lt 4 ]; then
  ...
  CALLDATA=$(cast calldata "finalizeUpgrade_v4(address)" "$AGENT")
  ...
  grant_sr_role "ACCOUNTING_REPORT_ROLE"                 "$ACCOUNTING"
