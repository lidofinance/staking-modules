...
# Network endpoints.
MAINNET_RPC_URL = os.getenv("MAINNET_RPC_URL", "http://localhost:8545")
HOODI_RPC_URL = os.getenv("HOODI_RPC_URL", "http://localhost:8545")
ARBITRUM_RPC_URL = os.getenv("ARBITRUM_RPC_URL", "http://localhost:8545")
MAINNET_ARCHIVE_RPC_URL = os.getenv("MAINNET_ARCHIVE_RPC_URL", MAINNET_RPC_URL)
HOODI_ARCHIVE_RPC_URL = os.getenv("HOODI_ARCHIVE_RPC_URL", HOODI_RPC_URL)
...
ELIGIBLE_ADDRESSES_HOLESKY_PATH = EXPERIENCE_DATA_DIR / "eligible_addresses_holesky.json"
